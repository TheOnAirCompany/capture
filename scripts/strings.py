...
FR = {
    ...
    "iPad Isn't Supported Yet": "L’iPad n’est pas encore pris en charge",
    "Capture works with iPhone for now. Connect an iPhone with a USB cable to preview and capture its screen.": "Capture fonctionne avec l’iPhone pour le moment. Branchez un iPhone avec un câble USB pour afficher et capturer son écran.",
    "Choose an iPhone from the menu in the sidebar.": "Choisissez un iPhone dans le menu de la barre latérale.",
