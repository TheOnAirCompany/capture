...
FR = {
    ...
    "Screenshots and videos are saved in this folder.": "Les captures d’écran et vidéos sont enregistrées dans ce dossier.",
    "Demo Mode": "Mode démo",
    "Automatic": "Automatique",
    "Status Bar": "Barre d’état",
    "While Capture displays your iPhone, iOS switches its status bar to demo mode: 9:41, full battery and full signal.": f"Pendant que Capture affiche votre iPhone, iOS passe sa barre d’état en mode démo{NB}: 9:41, batterie pleine et réseau au maximum.",
    "Your screenshots and videos look clean and consistent, like Apple's own product shots, whatever the real time or battery level. No retouching needed, and nothing personal shows up in the status bar.": "Vos captures et vidéos sont propres et homogènes, comme les visuels d’Apple, quels que soient l’heure réelle ou le niveau de batterie. Aucune retouche nécessaire, et rien de personnel n’apparaît dans la barre d’état.",
    "iOS controls this mode: it turns on when Capture starts displaying your iPhone and turns off when you disconnect it. It can't be turned off from the Mac.": f"Ce mode est géré par iOS{NB}: il s’active quand Capture commence à afficher votre iPhone et se désactive quand vous le débranchez. Il ne peut pas être désactivé depuis le Mac.",
