...
FR = {
    ...
    "Capture is up to date.": "Capture est à jour.",
    "No release has been published yet.": "Aucune version n’a encore été publiée.",
    "Version %@ is available.": "La version %@ est disponible.",
    "Couldn't check for updates.": "Impossible de rechercher les mises à jour.",
    "Model": "Modèle",
